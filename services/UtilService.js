...
angularApp.service('UtilService', ['$state','$rootScope', '$http', 'LoginVaildationService', '$filter', 'JSONService', function ($state,$rootScope, $http, userSession, $filter, jsonService) {
